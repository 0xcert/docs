# Welcome to 0xcert Framework v1.x

The 0xcert (pronounced [zeer-oh-eks-surt]) Framework is a JavaScript platform that provides tools for building powerful decentralized applications (dapps).
